...
void esp_MD5Calc(const unsigned char* input, unsigned int inlen, unsigned char* output)
{
    MD5_CTX context;
    esp_MD5Init(&context);
    // Md5 Key
...
//     0xd4, 0xb4, 0x4f, 0xff, 0x9b, 0x45, 0x3a, 0xf5, 0x00 };
    //esp_MD5Update(&context, (unsigned char *)initStr, 32);
    esp_MD5Update(&context, (unsigned char*)input, inlen);
    esp_MD5Final(output, &context);
}
